...
function _search() {
    _search = $22bbea2e4f5d5dfd$export$2e2bcd8739ae039((/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports)).mark(function _callee(value) {
        var maxResults, values, pool, results, scores, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, value1, _iteratorNormalCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, emoji, score, _args = arguments;
        return (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports)).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    maxResults = (_args.length > 1 && _args[1] !== void 0 ? _args[1] : {
                    }).maxResults;
...
function __init() {
    __init = $22bbea2e4f5d5dfd$export$2e2bcd8739ae039((/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports)).mark(function _callee(props) {
        var emojiVersion, set, locale, alias, emojiId, emoji, i, category, prevCategory, ids, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, emoji1, latestVersionSupport, noCountryFlags, categoryIndex, resetSearchIndex, category1, categoryIcons, icon, emojiIndex, emoji2, ignore, _iteratorNormalCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, emoticon, skinIndex, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, skin, native, skinShortcodes;
        return (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports)).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                ...
                case 35:
                    if ($b79b4feb8fc394aa$export$dbe3113d60765c1a) {
                        _ctx.next = 54;
                        break;
                    }
                ...
                case 63:
                    ...
                    _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                    _ctx.prev = 69;
                    _iterator = category.emojis[Symbol.iterator]();
                case 71:
                    if (_iteratorNormalCompletion = (_step = _iterator.next()).done) {
                        _ctx.next = 80;
                        break;
                    ...
                    emoji1 = _step.value;
                    if (!(ids.indexOf(emoji1.id) > -1)) {
                        _ctx.next = 75;
                        break;
                    }
                    return _ctx.abrupt("continue", 77);
                case 75:
                ...
                case 89:
                    ...
                    throw _iteratorError;
                case 92:
                    return _ctx.finish(89);
                case 93:
                    return _ctx.finish(86);
                case 94:
                    category.emojis = ids;
                    _ctx.next = 56;
                    break;
                ...
                case 103:
                    ...
                    if (category1.id == 'frequent') category1.emojis = $26c4208b83093c27$export$2e2bcd8739ae039.get(props);
                    if (!(!category1.emojis || !category1.emojis.length)) {
                        _ctx.next = 109;
                        break;
                    }
                    $b79b4feb8fc394aa$export$2d0294657ab35f1b.categories.splice(categoryIndex, 1);
                    return _ctx.abrupt("continue", 103);
                case 109:
                ...
                case 112:
                    ...
                    emoji2 = $b79b4feb8fc394aa$export$2d0294657ab35f1b.emojis[category1.emojis[emojiIndex]];
                    ignore = function() {
                    ...
                    ignore();
                    return _ctx.abrupt("continue", 112);
                case 118:
                ...
                case 132:
                    ...
                    return _ctx.abrupt("continue", 137);
                case 136:
                ...
                case 149:
                    ...
                    throw _iteratorError1;
                case 152:
                    return _ctx.finish(149);
                case 153:
                    return _ctx.finish(146);
                case 154:
                    skinIndex = 0;
                ...
                case 158:
                    ...
                    return _ctx.abrupt("continue", 167);
                case 162:
                    skinIndex++;
                    native = skin.native;
                    if (native) {
                ...
                case 182:
                    return _ctx.finish(179);
                case 183:
                    return _ctx.finish(176);
                case 184:
                    _ctx.next = 112;
                    break;
                case 186:
...
var $5275416a750983b0$var$WindowHTMLElement = typeof window !== 'undefined' ? window.HTMLElement : Object;
            ...
            value: function componentWillReceiveProps(nextProps) {
                ...
                for(var k in nextProps){
                    ...
                    if (k === 'custom' || k === 'categories') this.reset();
                        ...
                        this.setState($1459522e281add88$export$2e2bcd8739ae039({
                        }, k, initalState[k]));
                    }
                }
            }
